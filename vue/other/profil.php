...
<html>
    ...
    <body>
          ...
          <a class="navbar-brand row d-flex align-items-center" href="">
            ...
            <div class="collapse navbar-collapse"  id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto navbarPerso" id="lienNav">
                ...
                <li class="nav-item">
                  <a class="nav-link " href="autreTravaux.php">Travaux</a>
                  <a class="nav-link " href="autreTravaux.php"><i class="material-icons">work</i></a>
                </li>
                <li class="nav-item">
      ...
      <main class="m-3 bg-faded">
        <section>
          <section class='d-flex justify-content-around flex-wrap align-items-center'>
            <img class="h-100 w-100 col-5 col-sm-5 col-md-3 col-lg-6 m-2" src="../../img/photo.png" alt="">
            <article class="text-center col-sm-12 col-md-12 col-lg-5">
              <h5>Bonjour, je m'appels baptiste ventura, je suis développeur web junior.</h5>
              <p>J'ai suivis un parcours assez éclectique, en allant d'abord suivre une licence d'art plastique, puis en obtenant une licence pro level design à Gamagora. Je suis ensuite allé aux beaux arts en art numérique, ayant voulu apprendre l'animation mais n'ai pas vraiment réussit à trouver ce que je cherchais.</p>
              <p>C'est seulement après que j'ai décidé d'apprendre le développement informatique. J'ai tenté un DUT informatique à Orsay, mais sans succès. J'ai insisté et ai décidé de m'orienter davantage sur le développement web. Pour cela, je suis allé à la formation simplon, dans laquelle j'ai appris à la fois l'intégration web, le front et le back end. J'ai toutefois une préférence pour le back, cherchant davantage à apprendre le php, ainsi que la maitrise de Laravel.</p>
            </article>
          </section>
        </section>
      </main>
